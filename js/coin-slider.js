...
(function ($) {
	...
	$.fn.coinslider = $.fn.CoinSlider = function (options) {
		...
		var setNavigation = function (el) {
			...
			if (params[el.id].showNavigationPrevNext) {
				...
				$('#cs-navigation-' + el.id).append("<a href='#' id='cs-prev-" + el.id + "' class='cs-prev glyphicon glyphicon-chevron-left'>"+"</a>");
				$('#cs-navigation-' + el.id).append("<a href='#' id='cs-next-" + el.id + "' class='cs-next glyphicon glyphicon-chevron-right'>"+"</a>");
				$('#cs-prev-' + el.id).css({
					'position'		: 'absolute',
	...
	$.fn.coinslider.defaults = {
		width: 1300, // width of slider panel
