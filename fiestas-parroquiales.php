...
<div class="panel-heading styleBellaMAria"><h2>FIESTAS PARROQUIALES</h2></div>
<div class="panel-body">

<?php 
        require("clases/conexion.php");
        $con = conectar();
        $sql = "SELECT * FROM modulo WHERE tip_modulo='FIESTAS PARRROQUIALES' ORDER BY id_modulo DESC";
