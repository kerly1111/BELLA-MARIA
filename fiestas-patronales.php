...
<div class="panel-heading styleBellaMAria"><h2>FIESTAS PATRONALES</h2></div>
<div class="panel-body">

<?php 
        require("clases/conexion.php");
        $con = conectar();
        $sql = "SELECT * FROM modulo WHERE tip_modulo='FIESTAS PATRONALES' ORDER BY id_modulo DESC";
